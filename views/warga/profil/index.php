...
<style>
    .profile-banner {
        height: 120px;
        background: linear-gradient(135deg, #1e4080 0%, #0f2342 100%);
        position: relative;
    ...
    .info-item-card:hover {
        ...
        box-shadow: 0 10px 25px rgba(30, 64, 128, 0.05) !important;
        background: #ffffff;
        border-color: rgba(30, 64, 128, 0.15);
    }
    ...
    .btn-edit-profile {
        background: linear-gradient(135deg, #1e4080 0%, #163566 100%);
        border: none;
        color: white;
        transition: all 0.3s ease;
        box-shadow: 0 4px 12px rgba(30, 64, 128, 0.2);
    }
    
    .btn-edit-profile:hover {
        background: linear-gradient(135deg, #2554a9 0%, #1e4080 100%);
        color: white;
        transform: translateY(-1px);
        box-shadow: 0 6px 15px rgba(30, 64, 128, 0.3);
    }
</style>
    ...
    <div class="col-lg-4">
        <div class="card border-0 rounded-4 shadow-sm overflow-hidden bg-white">
            <div class="profile-banner">
                <span class="official-badge"><i class="bi bi-shield-check me-1"></i> Terverifikasi</span>
            </div>
                ...
                <div class="profile-avatar-container">
                    <?php if (!empty($user['foto_profil'])): ?>
                        <img src="<?= APP_URL ?>/public/uploads/profil/<?= htmlspecialchars($user['foto_profil']) ?>" 
                             ...
                             alt="Foto Profil">
                    <?php else: ?>
                        <div class="bg-primary rounded-circle text-white d-flex align-items-center justify-content-center fw-bold profile-avatar mx-auto mb-3"
        ...
        <div class="card border-0 rounded-4 shadow-sm bg-white overflow-hidden">
            <div class="card-header bg-white py-4 border-0 d-flex align-items-center justify-content-between px-4">
                <span class="fw-bold text-dark fs-6">
                    <i class="bi bi-person-badge-fill me-2 text-primary"></i>Data Kependudukan Resmi
                </span>
