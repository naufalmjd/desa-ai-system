        ...
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden position-relative">
            ...
            <div class="card-header bg-white py-3 px-4 border-bottom-0">
                <h5 class="card-title fw-bold text-dark mb-0 d-flex align-items-center gap-2">
                    <i class="bi bi-person-plus text-success"></i> Tambah Data Penduduk
                </h5>
                <p class="text-muted small mb-0">Isi data lengkap sesuai dengan kartu keluarga dan KTP yang berlaku.</p>
            </div>

            <div class="card-body p-4 pt-1">
                <form method="POST" action="<?= APP_URL ?>/admin/penduduk/store" id="createPendudukForm">
                    ...
                    <div class="border-bottom pb-3 mb-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="tempat_lahir" class="form-control" placeholder="Kota / Kabupaten" required style="border-radius:10px;">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="pekerjaan" class="form-control" placeholder="Pekerjaan saat ini" required style="border-radius:10px;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="alamat" class="form-control" rows="2" placeholder="Nama Jalan, Blok, No. Rumah" required style="border-radius:10px;"></textarea>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label small fw-semibold text-secondary">RT <span class="text-danger">*</span></label>
                                <input type="text" name="rt" class="form-control" placeholder="Tiga digit (contoh: 001)" required pattern="\d{3}" maxlength="3" style="border-radius:10px;">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label small fw-semibold text-secondary">RW <span class="text-danger">*</span></label>
                                <input type="text" name="rw" class="form-control" placeholder="Tiga digit (contoh: 002)" required pattern="\d{3}" maxlength="3" style="border-radius:10px;">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label small fw-semibold text-secondary">Dusun <span class="text-danger">*</span></label>
                                <input type="text" name="dusun" class="form-control" placeholder="Nama Dusun" required style="border-radius:10px;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end gap-3 mt-4 pt-3 border-top">
                        ...
                        <button type="submit" id="submitBtn" class="btn btn-success px-4 py-2" style="border-radius:10px;">
                            <i class="bi bi-check-lg me-1.5"></i> Simpan Data
                        </button>
                    </div>
                </form>
            </div>
...
$footerExtra = <<<JS
<script>
document.getElementById('createPendudukForm').addEventListener('submit', function() {
